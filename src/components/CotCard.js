  ...
  return (
    <div className="cot-card">
      ...
      <div className="report-analysis">
          ...
          <section className={open_interest.filter ? "filter" : ""}>
            <h4>Open Interest</h4>
          ...
          <section className={asset_mgr_long.filter ? "filter" : ""}>
          ...
          <section className={asset_mgr_short.filter ? "filter" : ""}>
          ...
          <section className={lev_money_long.filter ? "filter" : ""}>
          ...
          <section className={lev_money_short.filter ? "filter" : ""}>
