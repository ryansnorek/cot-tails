  ...
  return (
    <div className="cot-card">
      ...
      <div className="report-analysis">
          ...
          <section className={open_interest.filter === true ? "filter" : ""}>
            <h4>Open Interest</h4>
          ...
          <section className={asset_mgr_long.filter === true ? "filter" : ""}>
          ...
          <section className={asset_mgr_short.filter === true ? "filter" : ""}>
          ...
          <section className={lev_money_long.filter === true ? "filter" : ""}>
          ...
          <section className={lev_money_short.filter === true ? "filter" : ""}>
          ...
          <section className={nonrept_positions_long.filter === true ? "filter" : ""}>
          ...
          <section className={nonrept_positions_short.filter === true ? "filter" : ""}>
